                    ...
                    .ajaxSubmit(
                        {
                            ...
                            success: function (data) {
                                if(data.count=="1"){
                                    alert("修改成功啦");
                                    location.href="../../sys/userlist.html";
                                }else{
                                    alert("修改失败啦");
                                    $("#Photo").next().html(data.message);
                                    return;
                                }
                            }
                        });
