...
<%@ page import="cn.jbit.smbms.entity.Bill" %>
<%@ page import="cn.jbit.smbms.entity.Page" %>
...
<div class="right">
       ...
       <form method="post" action="">
			...
			<span>商品名称：</span>
			<input name="queryProductName" id="productName" type="text" value="${queryProductName }">
			 
			<span>供应商：</span>
			<select name="queryProviderId" id="providerId">
			...
			<span>是否付款：</span>
			<select name="queryIsPayment"  id="isPay">
				<option value="0">--请选择--</option>
				<option value="1" ${queryIsPayment == 1 ? "selected=\"selected\"":"" }>未付款</option>
				<option value="2" ${queryIsPayment == 2 ? "selected=\"selected\"":"" }>已付款</option>
       		</select>
			
			 <input	value="查 询" type="button" class="searchbutton" id="1">
			 <a href="${pageContext.request.contextPath }/sys/toAddBill">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
      <table class="providerTable" cellpadding="0" cellspacing="0">
          <%--<tr class="firstTr">--%>
              ...
              <%--<th width="30%">操作</th>--%>
          <%--</tr>--%>
			  <%--<c:forEach var="bill" items="${page.newPage}" varStatus="status">--%>
					<%--<tr>--%>
						<%--<td>--%>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/static/js/billlist.js">
</script>
