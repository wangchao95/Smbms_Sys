        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="">
                ...
                <div>
                    ...
                    <input type="hidden" value="${bill.provider.proName}" id="pid" />
					<select name="providerId" id="providerId">
                        <c:forEach var="provider" items="${proList}">
                            <c:if test="${provider.proName==bill.provider.proName}">
                                <option value="${provider.id}" selected="selected">${provider.proName}</option>
                            </c:if>
