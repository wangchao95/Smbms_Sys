...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="">
				...
				<span>供应商编码：</span>
				<input name="queryProCode" id="proCode" type="text" value="${queryProCode }">

				<span>供应商名称：</span>
				<input name="queryProName" id="proName" type="text" value="${queryProName }">

				<input value="查 询" type="button" id="searchbutton">
				<a href="${pageContext.request.contextPath }/sys/toAddProvider">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
