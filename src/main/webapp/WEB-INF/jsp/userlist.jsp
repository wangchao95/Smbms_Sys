        ...
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/UserServlet">
					<input name="action" value="userList" class="input-text" type="hidden">
					 <span>用户名：</span>
					 ...
					 <a href="${pageContext.request.contextPath}/sys/toAddUser" >添加用户</a>
				</form>
            </div>
            <!--用户-->
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <%--<tr class="firstTr">--%>
                    ...
                    <%--<th width="30%">操作</th>--%>
                <%--</tr>--%>
                   <%--<c:forEach var="user" items="${page.newPage}" varStatus="status">--%>
					<%--<tr>--%>
						<%--<td>--%>
